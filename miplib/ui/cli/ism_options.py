...
def get_ism_reconstruction_options_group(parser):
    ...
    group = parser.add_argument_group(
        "ISM reconstruction", "Options for controlling the ISM reconstruction"
    )
    ...
    group.add_argument(
        "--ism-na", type=float, default=1.4, help="The objective numerical aperture."
    )
    group.add_argument(
        "--ism-alpha", type=float, default=0.5, help="The ISM reassignment factor."
    )
