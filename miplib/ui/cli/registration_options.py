...
def get_registration_options_group(parser):
    ...
    group.add_argument("--initializer-off", dest="initializer", action="store_false")
    group.add_argument(
        "--reg-method",
        dest="registration_method",
        choices=["mattes", "mean-squared-difference", "viola-wells", "correlation"],
        default="correlation",
    ...
    group.add_argument(
        ...
        type=float,
        default=0.1,
        help="Specify the number of samples to take from each histogram bin",
    )
    ...
    group.add_argument(
        ...
        type=int,
        default=0,
        help="Specify the axis for initial rotation of the moving image",
    )
    group.add_argument(
        "--set-rotation",
        dest="set_rotation",
    ...
    group.add_argument(
        "--set-scaling-scale", dest="scaling_scale", type=float, default=10.0
    )
    group.add_argument(
        "--max-step",
    ...
    group.add_argument("--x-offset", dest="x_offset", type=float, default=0.0)
    group.add_argument("--y-offset", dest="y_offset", type=float, default=0.0)
    group.add_argument("--z-offset", dest="z_offset", type=float, default=0.0)
    ...
    group.add_argument(
        "--reg-print-prog", dest="print_registration_progress", action="store_true"
    )
    group.add_argument("--reg-enable-observers", action="store_true")

    group.add_argument("--reg-translate-only", action="store_true")
    group.add_argument(
        "--use-internal-type", dest="use_internal_type", action="store_true"
    )
    group.add_argument("--disable-init-moments", dest="moments", action="store_false")
    group.add_argument(
        "--mask-threshold",
        dest="mask_threshold",
        type=int,
    ...
    group.add_argument("--learning-rate", dest="learning_rate", type=float, default=0.7)
