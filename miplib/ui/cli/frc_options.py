...
def get_frc_options_group(parser):
    ...
    group = parser.add_argument_group(
        "Fourier ring correlation analysis", "Options for FRC analysis"
    )
    ...
    group.add_argument(
        "--frc-curve-fit-degree", dest="frc_curve_fit_degree", type=int, default=8
    )

    group.add_argument(
        "--resolution-threshold-curve-fit-degree",
    ...
    group.add_argument(
        "--resolution-threshold-criterion",
    ...
    group.add_argument(
        ...
        type=float,
        default=1.0 / 7,
        help="The resolution threshold value to be used when fixed thresholdis applied",
    )

    group.add_argument(
        "--resolution-point-sigma",
        type=float,
        default=0.01,
    ...
    group.add_argument("--disable-hamming", action="store_true")
