...
from miplib.ui.deconvolution_options import get_deconvolution_options
from miplib.ui.options_parsers import parseRangeList, parseFromToString, parseCommaSeparatedList


# CLI SCRIPT ARGUMENTS
# The miplib scripts located in the /bin each have their specific
...
def get_debug_script_options(arguments):
    parser = argparse.ArgumentParser(
        description="Command line arguments for the "
                    "miplib image scanning microscopy"
